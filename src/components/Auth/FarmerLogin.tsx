    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-xl shadow-lg p-8">
        ...
        <div className="text-center mb-8">
          <h3 className="text-2xl font-bold text-gray-900">Farmer Login</h3>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-6 text-sm">
          ...
          <div><strong>ID:</strong> FARMER001</div>
          <div><strong>Password:</strong> farmer123</div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label className="block text-gray-700 mb-2">Farmer ID</label>
            <input
              type="text"
              name="farmerId"
